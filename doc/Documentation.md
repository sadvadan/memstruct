...
- Compile time checks & reporting wherever possible. (*O1 and above helps, too; and no, the often heard "all checks are compile time" simply isn't true: of this or any other system!)
