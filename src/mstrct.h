...
#define MSTRCT_GET_10(name, i, index) (*((typeof(name.typ[0])) (mstrct_check(name.id, MSTRCT_GETX(name), \
...
#define MSTRCT_CLEAN_01(line, off) __attribute__((cleanup(mstrct_cleanup))) uint16_t MSTRCT_CAT2(mstrct_s_, line) = off;
